...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClusterTemplate.user_clustertemplate_id'
        db.add_column('cluster_clustertemplate', 'user_clustertemplate_id', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ClusterTemplate.user_clustertemplate_id'
        db.delete_column('cluster_clustertemplate', 'user_clustertemplate_id')
